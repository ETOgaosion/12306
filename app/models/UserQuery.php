...
class UserQuery
{
    ...
    {
        return Database::selectAll("select * from get_train_bt_cities('{$start_city}', '{$end_city}', '{$start_date}', '{$start_time}', true) dirc_tr_btc order by dirc_tr_btc.seat_prices[1] DESC, dirc_tr_btc.seat_prices[2] DESC, dirc_tr_btc.seat_prices[3] DESC, dirc_tr_btc.seat_prices[4] DESC, dirc_tr_btc.seat_prices[5] DESC, dirc_tr_btc.seat_prices[6] DESC, dirc_tr_btc.seat_prices[7] DESC, dirc_tr_btc.durance ASC, dirc_tr_btc.leave_time ASC");
    }
