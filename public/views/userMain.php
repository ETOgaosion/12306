...
<!-- Map css api link -->
<link href="https://cdn.jsdelivr.net/gh/openlayers/openlayers.github.io@master/en/v6.14.1/css/ol.css" rel="stylesheet" type="text/css">
                ...
                <div class="row h-50 w-100">
                    <div class="row flex-row align-items-center bg-light h-100" style="border-radius: 1rem">
                        <div class="nav col-4 nav-pills h-100 flex-column justify-content-center align-items-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <button class="nav-link" id="v-pills-train-tab" data-bs-toggle="pill" data-bs-target="#v-pills-train" type="button" role="tab" aria-controls="v-pills-train" aria-selected="false">列车查询</button>
                        </div>
