                ...
                <form class="h-100 p-3 d-flex flex-column justify-content-between" id="loginForm" action="login" method="post">
                    <div class="p-1 position-relative" style="height: 50%" id="loginInputRegion">
                        <div class="row align-items-center p-1">
                            ...
                            <div class="col-7">
                                <input type="text" name="loginUserNameInput" id="loginUserNameInput" class="form-control">
                            </div>
                        </div>
                        <div class="row align-items-center p-1">
                            <div class="col-5 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="password" name="loginPasswordInput" id="loginPasswordInput" class="form-control" aria-describedby="passwordHelpInline">
                            </div>
                        </div>
                ...
                <form class="h-100 ps-3 pe-3 d-flex flex-column justify-content-between" id="registerForm" action="login" method="post">
                    <div class="p-1 position-relative" style="height: 75%" id="registerInputRegion">
                        <div class="row align-items-center p-1">
                            ...
                            <div class="col-7">
                                <input type="text" name="registerUserNameInput" id="registerUserNameInput" class="form-control">
                            </div>
                        </div>
                        <div class="row align-items-center p-1">
                            <div class="col-5 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="password" name="registerPasswordInput" id="registerPasswordInput" class="form-control" aria-describedby="passwordHelpInline">
                            </div>
                        </div>
                        <div class="row align-items-center p-1">
                            <div class="col-5 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="email" name="registerEmailInput" id="registerEmailInput" class="form-control">
                            </div>
                        </div>
                        <div class="row align-items-center p-1">
                            <div class="col-5 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="tel" name="registerTelNumInput" id="registerTelNumInput" class="form-control"">
                            </div>
                        </div>
                        <div class="row align-items-center p-1" id="registerRealNameInputDiv">
                            ...
                            <div class="col-7">
                                <input type="text" name="registerRealNameInput" id="registerRealNameInput" class="form-control">
                            </div>
                        </div>
                        <div class="row align-items-center p-1" id="registerAuthorDiv" style="display: none;">
                            ...
                            <div class="col-7">
                                <input type="number" name="registerAuthorityInput" id="registerAuthorityInput" class="form-control">
                            </div>
                        </div>
                        <div class="row align-items-center p-1" id="registerAuthenDiv" style="display: none;">
                            ...
                            <div class="col-7">
                                <input type="password" name="registerAuthenticationInput" id="registerAuthenticationInput" class="form-control"
                                       aria-describedby="passwordHelpInline">
                            </div>
                        </div>
                    </div>
